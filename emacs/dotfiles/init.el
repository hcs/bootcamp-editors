...
(global-set-key (kbd "C-m") 'ecb-activate)       ;; directory & code outline bars
(global-set-key (kbd "M-m") 'ecb-deactivate)

;; Hotkeys VIM-like Movement - uncomment this if you want it
...
;; color theme using solarized - uncomment this if you want it
